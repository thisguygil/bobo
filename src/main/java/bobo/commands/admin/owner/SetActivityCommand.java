...
public class SetActivityCommand extends AbstractOwner {
    ...
    protected void handleOwnerCommand() {
        ...
        OptionMapping optionMapping = activityType.equals("custom") ? event.getOption("status") : event.getOption("activity");
        assert optionMapping != null;
        String activityName = optionMapping.getAsString();
        ...
        String message = switch (activityType) {
            ...
            case "streaming" -> "Activity set to **Streaming " + activityName + "**";
        ...
        try (Connection connection = SQLConnection.getConnection();
            ...
            if (resultSet.next()) {
                ...
                activity = switch (activityType) {
                    ...
                    case "streaming" -> Activity.streaming(activityName, "https://www.youtube.com/watch?v=dQw4w9WgXcQ");
